class AppConstants {
  ...
  // OpenAI models
  static const String modelFree = 'gpt-4.1-mini';
  static const String modelPremium = 'gpt-4.1';
  ...
  static List<String> allBooksARC() => [...oldTestamentBooks, ...newTestamentBooks];
  static List<String> allBooksKJV() => [...oldTestamentBooksKJV, ...newTestamentBooksKJV];
}
